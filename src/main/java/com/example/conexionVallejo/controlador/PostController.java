...
public class PostController {
    ...
    private void deleteQuestionWithAnswers(Post question) {
        try {
            ...
            reportRepository.deleteByPost(question);
            likeDislikeRepository.deleteByPost(question);
    ...
    @PostMapping("/save")
    @ResponseBody
    public ResponseEntity<Map<String, Object>> savePost(@RequestParam("postId") Long postId, Authentication authentication) {
            ...
            if (optionalUser.isPresent()) {
                ...
                if (optionalPost.isPresent()) {
                    ...
                    if (existingSavedPost.isPresent()) {
                        ...
                        response.put("message", "Publicación eliminada de tus guardados");
                        ...
                        response.put("message", "Publicación guardada en tus favoritos");
                        response.put("type", "success");
                    }
                } else {
    ...
    @ResponseBody
    public ResponseEntity<Map<String, String>> reportPost(@RequestParam("postId") Long postId,
        ...
        if (authentication != null && authentication.isAuthenticated()) {
            ...
            if (optionalUser.isPresent()) {
                ...
                if (optionalPost.isPresent()) {
                    ...
                    boolean alreadyReported = reportRepository.existsByUserAndPost(user, post);
                    ...
                    if (!alreadyReported) {
                        ...
                        response.put("message", "Denuncia enviada correctamente");
                        response.put("type", "success");
                    } else {
                        response.put("message", "Ya has denunciado esta publicación anteriormente");
                        response.put("type", "error");
                    }
                } else {
                    response.put("message", "No se encontró la publicación con el ID especificado");
    ...
    @PostMapping("/report/answer")
    @ResponseBody
    public ResponseEntity<Map<String, String>> reportAnswer(@RequestParam("answerId") Long postId,
                                                          @RequestParam("reason") String reason,
                                                          Authentication authentication) {
        Map<String, String> response = new HashMap<>();
